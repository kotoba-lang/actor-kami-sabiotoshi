...
(defn collection
  [name]
  (str "com.etzhayyim.kami-sabiotoshi." name))

(def cell-specs {
  :listitems {:legacy-cell "com-etzhayyim-apps-kami-sabiotoshi-listItems"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "listitems")]
     :required-gates common-gates
     :trigger "manifest cell listitems"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :createitem {:legacy-cell "com-etzhayyim-apps-kami-sabiotoshi-createItem"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "createitem")]
     :required-gates common-gates
     :trigger "manifest cell createitem"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :scorezone {:legacy-cell "com-etzhayyim-apps-kami-sabiotoshi-scoreZone"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "scorezone")]
     :required-gates common-gates
     :trigger "manifest cell scorezone"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :get {:legacy-cell "com-etzhayyim-apps-kamisabiotoshi-coverage-get"
     :phase :event
     :murakumo-node "reuben"
  ...
  :domain-knowledge {:legacy-cell "domain-knowledge"
     ...
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :sabiotoshi {:legacy-cell "com-etzhayyim-apps-kami-sabiotoshi"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "sabiotoshi")]
     :required-gates common-gates
     :trigger "manifest cell sabiotoshi"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :rustyitem {:legacy-cell "com-etzhayyim-apps-kami-sabiotoshi-rustyItem"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "rustyitem")]
     :required-gates common-gates
     :trigger "manifest cell rustyitem"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :rustzone {:legacy-cell "com-etzhayyim-apps-kami-sabiotoshi-rustZone"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "rustzone")]
     :required-gates common-gates
     :trigger "manifest cell rustzone"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
})
